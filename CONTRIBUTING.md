# Contributing to Material Studies

We would love for you to contribute to Material Studies and help make it even better than it is
...
Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [Stack Overflow][stackoverflow]) where the questions should be tagged with tag `Material Studies`.
...
1. Search [GitHub](https://github.com/herodevs/material-studies/pulls) for an open or closed PR
